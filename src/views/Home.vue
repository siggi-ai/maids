<template>
    <Navigation />
    <div
      class="flex flex-col min-[780px]:flex-row items-center pt-8 md:justify-center md:pt-0 bg-cherry min-h-screen bg-cover bg-no-repeat"
    >
  
    <!-- load image by selected option -->
    <div class="flex flex-col p-8 md:pt-36">
      ...
      <div>
        ...
        <div v-else class="-pt-16">
          ...
          >
            ...
            <img
              v-if="apiResponseData.images"
              :src="apiResponseData.images[0].url"
              alt="waifu"
              class="h-[80vh shrink-0] md:h-[80vh] h-96"
            />
          </button>
        </div>
      </div>
